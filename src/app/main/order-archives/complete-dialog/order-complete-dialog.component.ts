...
@Component({
  selector: 'app-order-archive-complete-dialog',
  templateUrl: './order-complete-dialog.component.html',
  styleUrls: ['./order-complete-dialog.component.scss'],
  providers: [DatePipe]
})
export class OrderArchiveCompleteDialogComponent implements OnInit {
  selectedOrder: Order;
  title: string;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<OrderArchiveCompleteDialogComponent>,
